...
<html lang="id" x-data="{
    ...
    isScrolled: false
}" x-init="window.addEventListener('scroll', () => { isScrolled = window.scrollY > 20; })" :class="{ 'dark': $store.app.darkMode }" x-cloak>
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center space-x-3">
                    ...
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                        <div
                            class="w-9 h-9 bg-gradient-to-br from-navy-600 to-navy-800 rounded-xl flex items-center justify-center shadow-md">
                ...
                <div class="flex items-center space-x-1 sm:space-x-2">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            style="display: none;">
                            <div
                                class="px-4 py-3 border-b border-gray-100 dark:border-navy-700 flex items-center justify-between">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <button @click="open = !open"
                            ...
                            <!-- Avatar -->
                            <div
                                class="w-8 h-8 bg-gradient-to-br from-navy-500 to-navy-700 rounded-full flex items-center justify-center flex-shrink-0 shadow-sm">
                        ...
                        <div x-show="open" @click.away="open = false"
                            ...
                            <div class="px-4 py-3 border-b border-gray-100 dark:border-navy-700">
                                <div class="flex items-center space-x-3">
                                    <div
                                        class="w-10 h-10 bg-gradient-to-br from-navy-500 to-navy-700 rounded-full flex items-center justify-center flex-shrink-0">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <span
                                            class="inline-block mt-1 px-2 py-0.5 text-xs font-medium rounded-full {{ Auth::user()->role_color }}">
                                            {{ Auth::user()->role_label }}
                                        </span>
                                    </div>
                                </div>
                            ...
                            <div class="py-1">
                                <a href="{{ route('profile') }}"
                                    ...
                                    <div
                                        class="w-8 h-8 bg-navy-50 dark:bg-navy-700 rounded-lg flex items-center justify-center mr-3 group-hover:bg-navy-100 dark:group-hover:bg-navy-600 transition-colors">
                                        <svg class="w-4 h-4 text-navy-600 dark:text-navy-300" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <a href="{{ route('profile') }}#password"
                                    class="flex items-center px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-navy-700/70 transition-colors group">
                                    <div
                                        class="w-8 h-8 bg-gold-50 dark:bg-navy-700 rounded-lg flex items-center justify-center mr-3 group-hover:bg-gold-100 dark:group-hover:bg-navy-600 transition-colors">
                                        <svg class="w-4 h-4 text-gold-600 dark:text-gold-400" fill="none"
                                            stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                @hasrole('superadmin|admin')
                                    ...
                                    <a href="{{ route('roles.index') }}"
                                        class="flex items-center px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-gray-50 dark:hover:bg-navy-700/70 transition-colors group">
                                        <div
                                            class="w-8 h-8 bg-purple-50 dark:bg-navy-700 rounded-lg flex items-center justify-center mr-3 group-hover:bg-purple-100 dark:group-hover:bg-navy-600 transition-colors">
                            ...
                            <div class="border-t border-gray-100 dark:border-navy-700 pt-1 pb-1">
                                <form method="POST" action="{{ route('logout') }}">
                                    ...
                                    <button type="submit"
                                        ...
                                        <div
                                            class="w-8 h-8 bg-red-50 dark:bg-red-900/20 rounded-lg flex items-center justify-center mr-3 group-hover:bg-red-100 dark:group-hover:bg-red-900/30 transition-colors">
    ...
    <div class="flex pt-16 min-h-screen">
        ...
        <aside id="sidebar"
            ...
            <div class="p-4 border-b border-gray-200 dark:border-navy-700 pt-20">
                <div
                    class="flex items-center space-x-3 p-3 bg-gradient-to-r from-navy-50 to-navy-100 dark:from-navy-700 dark:to-navy-600 rounded-xl">
                    <div
                        class="w-11 h-11 bg-gradient-to-br from-navy-500 to-navy-700 rounded-xl flex items-center justify-center shadow-md flex-shrink-0">
                    ...
                    <div class="flex-1 min-w-0">
                        ...
                        <span
                            class="inline-block mt-0.5 px-2 py-0.5 text-xs font-medium rounded-full {{ Auth::user()->role_color }}">
                            {{ Auth::user()->role_label }}
                        </span>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('kepegawaian.*') ? 'true' : 'false' }} }" class="space-y-0.5">
                    ...
                    <div x-show="open" x-collapse class="pl-10 space-y-0.5">
                        ...
                        <a href="{{ route('kepegawaian.pegawai.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors
        {{ request()->routeIs('kepegawaian.pegawai*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">
                            Kelola Data Pegawai
                        </a>
                    </div>
                </div>
                ...
                <div x-data="{ open: {{ request()->routeIs('anggaran.*') ? 'true' : 'false' }} }" class="space-y-0.5">
                    ...
                    <div x-show="open" x-collapse class="pl-10 space-y-0.5">
                        <a href="{{ route('anggaran.data.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('anggaran.data.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Kelola
                            Data Anggaran</a>
                        <a href="{{ route('anggaran.monitoring.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('anggaran.monitoring.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Monitoring
                            Anggaran</a>
                        <a href="{{ route('anggaran.spp.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('anggaran.spp.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Data
                            SPP</a>
                        <a href="{{ route('anggaran.usulan.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('anggaran.usulan.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Usulan
                            Penarikan Dana</a>
                        <a href="{{ route('anggaran.dokumen.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('anggaran.dokumen.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Dokumen
                            Capaian Output</a>
                        <a href="{{ route('anggaran.revisi.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('anggaran.revisi.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Revisi
                            Anggaran</a>
                    </div>
                </div>
                @endcanaccess
                ...
                <div x-data="{ open: {{ request()->routeIs('inventaris.*') ? 'true' : 'false' }} }" class="space-y-0.5">
                    ...
                    <div x-show="open" x-collapse class="pl-10 space-y-0.5">
                        <a href="{{ route('inventaris.kategori-atk.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('inventaris.kategori-atk.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Kategori
                            ATK</a>
                        <a href="{{ route('inventaris.monitoring-atk.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('inventaris.monitoring-atk.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Monitoring
                            ATK</a>
                        <a href="{{ route('inventaris.permintaan-atk.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('inventaris.permintaan-atk.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Permintaan
                            ATK</a>
                        <a href="{{ route('inventaris.kategori-aset.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('inventaris.kategori-aset.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Kategori
                            Aset</a>
                        <a href="{{ route('inventaris.aset-end-user.index') }}"
                            class="block px-3 py-2 text-sm rounded-lg transition-colors {{ request()->routeIs('inventaris.aset-end-user.*') ? 'text-navy-700 dark:text-gold-400 font-medium bg-navy-50 dark:bg-navy-700' : 'text-gray-500 dark:text-gray-400 hover:text-navy-700 dark:hover:text-gold-400 hover:bg-navy-50 dark:hover:bg-navy-700' }}">Aset
                            End User</a>
                    </div>
                </div>
                @endcanaccess
                ...
                @canaccess('users')
                <div class="pt-2 pb-1">
                    <p class="px-3 text-xs font-semibold text-gray-400 dark:text-gray-600 uppercase tracking-wider">
                        Administrasi</p>
                </div>
        ...
        <!-- Overlay (Mobile) -->
        <div x-show="$store.app.sidebarOpen" @click="$store.app.sidebarOpen = false"
        ...
        <main class="flex-1 min-w-0 transition-all duration-300 overflow-x-hidden"
            ...
            <div
                class="px-4 sm:px-6 lg:px-8 py-6 lg:py-8 min-h-screen bg-gray-50 dark:bg-navy-900 transition-colors duration-300">
                ...
                @else
                    @hasSection('title')
                        <div class="mb-6">
                            <h1 class="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white">@yield('title')
                            </h1>
                            @hasSection('subtitle')
                ...
                <!-- Flash Messages -->
                @if (session('success'))
                    <div class="mb-6 bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-400 px-4 py-3 rounded-xl flex items-center space-x-3"
                        data-auto-hide>
                ...
                @if (session('error'))
                    <div class="mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-700 text-red-800 dark:text-red-400 px-4 py-3 rounded-xl flex items-center space-x-3"
                        data-auto-hide>
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if (session('warning'))
                    <div
                        class="mb-6 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-700 text-yellow-800 dark:text-yellow-400 px-4 py-3 rounded-xl flex items-center space-x-3">
                        <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
