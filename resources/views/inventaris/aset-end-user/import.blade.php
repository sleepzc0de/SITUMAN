{{-- resources/views/inventaris/aset-end-user/import.blade.php --}}
@extends('layouts.app')
    ...
    <div class="max-w-4xl mx-auto">
        <div class="card">
            <div class="border-b border-gray-200 dark:border-navy-700 pb-4 mb-6">
                <h2 class="text-xl font-bold text-gray-900 dark:text-white">Import Data Aset dari Excel/CSV</h2>
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Upload file Excel atau CSV untuk mengimport data
                    aset secara massal</p>
            </div>
            ...
            <div class="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl">
                ...
                <ol class="text-sm text-blue-800 dark:text-blue-300 space-y-1 list-decimal list-inside">
                    ...
                    <li>Isi data aset sesuai dengan format yang ada di template</li>
                    <li>Pastikan nama kategori sesuai dengan kategori yang sudah ada di sistem</li>
                    <li>Format tanggal harus: dd/mm/yyyy (contoh: 15/01/2024)</li>
                    <li>Kondisi harus diisi dengan: baik, rusak ringan, rusak berat, atau hilang</li>
            ...
            <div class="mb-6 p-4 bg-gray-50 dark:bg-navy-800 rounded-xl">
                <h3 class="text-sm font-semibold text-gray-900 dark:text-white mb-3">Kategori Aset yang Tersedia:</h3>
            ...
            <div class="mb-6">
                <a href="{{ route('inventaris.aset-end-user.template') }}" class="btn-secondary inline-flex">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <!-- Upload Form -->
            <form action="{{ url('inventaris/aset-end-user-import') }}" method="POST" enctype="multipart/form-data">
                @csrf
