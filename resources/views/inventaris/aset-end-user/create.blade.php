    ...
    <div class="max-w-4xl mx-auto">
        <div class="card">
            <div class="border-b border-gray-200 dark:border-navy-700 pb-4 mb-6">
                ...
                <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Lengkapi form di bawah ini untuk menambahkan aset
                    baru</p>
            </div>
            ...
            <form action="{{ route('inventaris.aset-end-user.store') }}" method="POST">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="input-group">
                        ...
                        <select name="kategori_id" class="input-field @error('kategori_id') border-red-500 @enderror"
                            required>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="merek" value="{{ old('merek') }}"
                            class="input-field @error('merek') border-red-500 @enderror" placeholder="Contoh: Dell">
                        @error('merek')
                            <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="tipe" value="{{ old('tipe') }}"
                            class="input-field @error('tipe') border-red-500 @enderror" placeholder="Contoh: Latitude 5420">
                        @error('tipe')
                            <span class="text-xs text-red-500 mt-1">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="nilai_perolehan" value="{{ old('nilai_perolehan', 0) }}"
                            class="input-field @error('nilai_perolehan') border-red-500 @enderror" min="0"
                            step="0.01" required>
                    ...
                    <div class="input-group md:col-span-2">
                        ...
                        <textarea name="deskripsi" rows="3" class="input-field @error('deskripsi') border-red-500 @enderror"
                    ...
                    <div class="input-group md:col-span-2">
                        ...
                        <textarea name="catatan" rows="2" class="input-field @error('catatan') border-red-500 @enderror"
                ...
                <div
                    class="flex items-center justify-end space-x-3 mt-8 pt-6 border-t border-gray-200 dark:border-navy-700">
