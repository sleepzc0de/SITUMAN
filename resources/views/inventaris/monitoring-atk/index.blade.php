        ...
        <div class="card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-600 dark:text-green-400 mt-1">{{ $stats['stok_tersedia'] }}</p>
                </div>
        ...
        <div class="card">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-yellow-600 dark:text-yellow-400 mt-1">{{ $stats['stok_menipis'] }}</p>
                </div>
            ...
            <div class="flex-1">
                <form method="GET" class="flex flex-col md:flex-row gap-3">
                    <input type="text" name="search" value="{{ request('search') }}"
                        placeholder="Cari nama atau kode ATK..."
            ...
            <table class="w-full">
                <thead class="bg-gray-50 dark:bg-navy-800">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">Nama ATK</th>
                    ...
                    @forelse($atk as $index => $item)
                        <tr class="hover:bg-gray-50 dark:hover:bg-navy-800 transition-colors">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm font-mono text-navy-600 dark:text-navy-300">{{ $item->kode_atk }}</span>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-medium text-gray-900 dark:text-white">{{ $item->nama }}</div>
                                @if($item->deskripsi)
                                    <div class="text-xs text-gray-500 dark:text-gray-400 mt-1">{{ Str::limit($item->deskripsi, 50) }}</div>
                                @endif
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="9" class="px-6 py-8 text-center text-gray-500 dark:text-gray-400">
                                ...
                                <p class="text-sm mt-1">Mulai dengan menambahkan ATK baru</p>
                            </td>
                        </tr>
                    @endforelse
                </tbody>
