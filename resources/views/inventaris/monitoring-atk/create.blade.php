{{-- resources/views/inventaris/monitoring-atk/create.blade.php --}}
@extends('layouts.app')

@section('title', 'Tambah ATK')

@section('breadcrumb')
    <x-breadcrumb :items="[
        ['title' => 'Inventaris', 'url' => null, 'active' => false],
        ['title' => 'Monitoring ATK', 'url' => route('inventaris.monitoring-atk.index'), 'active' => false],
        ['title' => 'Tambah ATK', 'url' => null, 'active' => true]
    ]" />
@endsection
...
<div class="max-w-4xl mx-auto">
    <div class="card">
        <div class="border-b border-gray-200 dark:border-navy-700 pb-4 mb-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Tambah ATK Baru</h2>
