...
<div class="max-w-2xl mx-auto">
    <div class="card">
        <div class="border-b border-gray-200 dark:border-navy-700 pb-4 mb-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Tambah Kategori ATK</h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Buat kategori baru untuk mengorganisir ATK</p>
        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="nama" value="{{ old('nama') }}"
                        ...
                        placeholder="Contoh: Alat Tulis" required>
                    @error('nama')
