...
<div class="max-w-5xl mx-auto">
    <div class="card">
        <div class="border-b border-gray-200 dark:border-navy-700 pb-4 mb-6">
            <h2 class="text-xl font-bold text-gray-900 dark:text-white">Buat Permintaan ATK Baru</h2>
            <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">Lengkapi form di bawah ini untuk membuat permintaan ATK</p>
        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-4">
                                ...
                                <div class="md:col-span-4">
                                    ...
                                    <input type="text" :name="'keterangan_item[' + index + ']'"
                                        class="input-field" placeholder="Opsional">
                                </div>
