...
@section('content')
    <div class="max-w-5xl mx-auto">
        <form action="{{ route('inventaris.permintaan-atk.store') }}" method="POST" x-data="permintaanForm()"
            @submit="validateForm">
            @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="input-group md:col-span-2">
                            ...
                            <textarea name="keterangan" rows="2" maxlength="1000"
                                ...
                                placeholder="Keterangan tambahan (opsional, max 1000 karakter)...">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <span class="input-hint-error">{{ $message }}</span>
                            @enderror
                        </div>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-12 gap-3 p-3 rounded-xl bg-gray-50 dark:bg-navy-800/60 border border-gray-100 dark:border-navy-700"
                                ...
                                <div class="md:col-span-5">
                                    ...
                                    <select :name="'atk_id[' + index + ']'" class="input-field" required>
                                        ...
                                        @foreach ($atk as $a)
                                            <option value="{{ $a->id }}" data-stok="{{ $a->stok_tersedia }}"
                                                data-satuan="{{ $a->satuan }}" data-status="{{ $a->status }}">
                                                {{ $a->nama }}
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="number" :name="'jumlah[' + index + ']'" class="input-field" min="1"
                                        max="9999" placeholder="0" required>
                                </div>
                                <div class="md:col-span-4">
                                    ...
                                    <input type="text" :name="'keterangan_item[' + index + ']'" class="input-field"
                                        maxlength="500" placeholder="Keterangan (opsional, max 500 char)">
                                </div>
