...
@section('breadcrumb')
    <x-breadcrumb :items="[
        ...
        ['title' => $permintaanAtk->nomor_permintaan, 'url' => route('inventaris.permintaan-atk.show', $permintaanAtk), 'active' => false],
...
<div>
    ...
    <p class="page-subtitle">
        Nomor: <span class="font-mono font-semibold text-navy-600 dark:text-navy-300">{{ $permintaanAtk->nomor_permintaan }}</span>
...
<div class="max-w-5xl mx-auto">
    <form action="{{ route('inventaris.permintaan-atk.update', $permintaanAtk) }}" method="POST"
          x-data="permintaanForm()">
        @csrf
        @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div class="input-group md:col-span-2">
                        ...
                        <textarea name="keterangan" rows="2"
                                  ...
                                  placeholder="Keterangan tambahan (opsional)...">{{ old('keterangan', $permintaanAtk->keterangan) }}</textarea>
                        @error('keterangan')
                        <span class="input-hint-error">{{ $message }}</span>
                        @enderror
                    </div>
                    ...
                    <template x-for="(item, index) in items" :key="index">
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-3 p-3 rounded-xl bg-gray-50 dark:bg-navy-800/60 border border-gray-100 dark:border-navy-700"
                            ...
                            <div class="md:col-span-5">
                                ...
                                <select :name="'atk_id[' + index + ']'"
                                        class="input-field" required x-model="item.atk_id">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="number" :name="'jumlah[' + index + ']'"
                                       class="input-field" min="1" placeholder="0"
                                       required x-model="item.jumlah">
                            </div>
