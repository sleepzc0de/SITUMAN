...
@section('content')
    ...
    }" x-init="tableHtml = $refs.tableContainer.innerHTML;
    window.addEventListener('change-page', e => changePage(e.detail.page));">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <div class="card flex items-center gap-4">
                <div
                    class="w-12 h-12 rounded-xl bg-yellow-100 dark:bg-yellow-900/30
            ...
            <div class="card flex items-center gap-4">
                ...
                <div class="min-w-0">
                    ...
                    <p class="stat-card-value text-red-600 dark:text-red-400" x-text="summaryData.rejected"></p>
        ...
        <div class="card">
            ...
            <div class="flex flex-col sm:flex-row gap-3 mb-5">
                ...
                <div class="flex-1 min-w-0">
                    <select x-model="filters.status" @change="fetchData()" class="input-field">
                ...
                <div class="flex-1 min-w-0">
                    <select x-model="filters.bulan" @change="fetchData()" class="input-field">
                ...
                <div class="flex-1 min-w-0">
                    <select x-model="filters.ro" @change="fetchData()" class="input-field">
                ...
                <button type="button" x-show="hasActiveFilter" x-transition @click="resetFilters()"
                    class="btn btn-ghost flex-shrink-0 text-xs" style="display:none;">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="relative">
                ...
                <div x-show="loading" x-transition:enter="transition-opacity duration-150"
                    ...
                    style="display:none;">
                    <div
                        class="flex items-center gap-3 px-5 py-3 bg-white dark:bg-navy-800
                            rounded-xl shadow-lg border border-gray-100 dark:border-navy-700">
                        <svg class="w-5 h-5 text-navy-600 dark:text-navy-400 animate-spin" fill="none"
                            viewBox="0 0 24 24">
                ...
                {{-- Table Container --}}
                <div x-ref="tableContainer" x-html="tableHtml"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="flex items-center gap-2">
                                                <div
                                                    class="w-7 h-7 rounded-full bg-navy-100 dark:bg-navy-700
                                                    flex items-center justify-center flex-shrink-0">
                    ...
                    @if ($usulans->hasPages())
                        <div
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                {{-- Page numbers --}}
                                @foreach ($usulans->getUrlRange(max(1, $usulans->currentPage() - 2), min($usulans->lastPage(), $usulans->currentPage() + 2)) as $pg => $url)
                                    <button type="button" x-data
    ...
    <div x-data="{
    ...
    }" x-show="open" x-transition:enter="transition-opacity duration-200"
        x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
        x-transition:leave="transition-opacity duration-150" x-transition:leave-start="opacity-100"
        ...
        <div @click.away="open = false" x-transition:enter="transition ease-out duration-200"
            ...
            x-transition:leave-end="opacity-0 scale-95" class="modal-box w-full max-w-md">
            ...
            <form :action="action" method="POST">
                ...
                <div class="modal-body space-y-4">
                    ...
                    <div class="input-group">
                        ...
                        <textarea name="keterangan" rows="4" class="input-field" maxlength="500"
                            placeholder="Jelaskan alasan penolakan secara detail... (maks. 500 karakter)" required></textarea>
                    </div>
                </div>
