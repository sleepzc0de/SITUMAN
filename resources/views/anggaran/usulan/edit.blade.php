                            ...
                            <div class="input-group">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="text" id="nilai_display"
                                        ...
                                        :class="{
                                            '!border-red-400 !ring-red-100 dark:!ring-red-900/30': sisaAnggaranWarning === 'danger',
                                            '!border-yellow-400 !ring-yellow-100 dark:!ring-yellow-900/30': sisaAnggaranWarning === 'warning'
                                        }"
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center">
                                    ...
                                    <span class="text-xs font-bold tabular-nums"
                                        :class="selectedInfo && (parseFloat(selectedInfo.sisa) < parseFloat(selectedInfo
                                                .pagu_anggaran) * 0.2) ?
