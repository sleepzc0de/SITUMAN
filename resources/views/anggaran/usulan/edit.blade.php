...
<div class="space-y-6">
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li class="text-navy-600 dark:text-navy-400 font-medium">Edit Usulan</li>
        </ol>
    </nav>

    <form action="{{ route('anggaran.usulan.update', $usulan) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="sub_komponen" value="{{ old('sub_komponen', $usulan->sub_komponen) }}"
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="nilai_usulan" value="{{ old('nilai_usulan', $usulan->nilai_usulan) }}"
                ...
                <div class="input-group md:col-span-2">
                    ...
                    <textarea name="keterangan" rows="4"
                              ...
                              placeholder="Keterangan usulan penarikan dana">{{ old('keterangan', $usulan->keterangan) }}</textarea>
                    @error('keterangan')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
