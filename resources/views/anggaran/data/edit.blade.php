                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="input-group">
                        ...
                        <input type="text" name="kegiatan" value="{{ old('kegiatan', $data->kegiatan) }}"
                            class="input-field @error('kegiatan') border-red-500 @enderror" placeholder="Contoh: 4753"
                            required>
                        @error('kegiatan')
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kro" value="{{ old('kro', $data->kro) }}"
                            class="input-field @error('kro') border-red-500 @enderror" placeholder="Contoh: EBA" required>
                        @error('kro')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="input-field bg-gray-100 dark:bg-navy-700"
                            value="@if (!$data->kode_akun) @if (!$data->kode_subkomponen)RO (Parent)@else Sub Komponen @endif
@else
Akun (Detail) @endif"
                            readonly>
                    </div>
                    ...
                    @if ($data->kode_subkomponen)
                        <div class="input-group">
                            ...
                            <input type="text" name="kode_subkomponen"
                                value="{{ old('kode_subkomponen', $data->kode_subkomponen) }}"
            ...
            <div class="card">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="input-group md:col-span-2">
                        <label class="input-label">Program/Kegiatan/Output/Komponen/Akun <span
                                class="text-red-500">*</span></label>
                        <textarea name="program_kegiatan" rows="3" class="input-field @error('program_kegiatan') border-red-500 @enderror"
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="pic" value="{{ old('pic', $data->pic) }}"
                            class="input-field @error('pic') border-red-500 @enderror" placeholder="Penanggung Jawab"
                            required>
                        @error('pic')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="input-group">
                        ...
                        @if (!$data->kode_akun)
                            <input type="number" class="input-field bg-gray-100 dark:bg-navy-700"
                                value="{{ old('pagu_anggaran', $data->pagu_anggaran) }}" placeholder="0" step="0.01"
                                readonly>
                        ...
                        @else
                            <input type="number" name="pagu_anggaran"
                                ...
                                class="input-field @error('pagu_anggaran') border-red-500 @enderror" placeholder="0"
                                step="0.01" required>
                            @error('pagu_anggaran')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
