...
<div class="space-y-6">
    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li class="text-navy-600 dark:text-navy-400 font-medium">Edit SPP</li>
        </ol>
    </nav>

    <form action="{{ route('anggaran.spp.update', $spp) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="tgl_spp" value="{{ old('tgl_spp', $spp->tgl_spp ? $spp->tgl_spp->format('Y-m-d') : '') }}"
                ...
                <div class="input-group md:col-span-2">
                    ...
                    <textarea name="uraian_spp" rows="3"
                              ...
                              placeholder="Uraian lengkap SPP" required>{{ old('uraian_spp', $spp->uraian_spp) }}</textarea>
                    @error('uraian_spp')
                        <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                    @enderror
                </div>
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="input-group">
                    ...
                    <input type="text" name="kode_kegiatan" value="{{ old('kode_kegiatan', $spp->kode_kegiatan) }}"
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="kro" value="{{ old('kro', $spp->kro) }}"
                ...
                <div class="input-group">
                    ...
                    <select name="sub_komponen" id="sub_komponen" class="input-field @error('sub_komponen') border-red-500 @enderror" required>
                        ...
                        @foreach($subkomponenList as $subkomp)
                            <option value="{{ $subkomp->kode_subkomponen }}" {{ old('sub_komponen', $spp->sub_komponen) == $subkomp->kode_subkomponen ? 'selected' : '' }}>
                    ...
                    <select name="mak" id="mak" class="input-field @error('mak') border-red-500 @enderror" required>
                        ...
                        @foreach($akunList as $akun)
                            <option value="{{ $akun->kode_akun }}"
                                    data-kegiatan="{{ $akun->kode_kegiatan }}"
                                    data-kro="{{ $akun->kro }}"
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="input-group">
                    ...
                    <input type="text" name="nomor_surat_tugas" value="{{ old('nomor_surat_tugas', $spp->nomor_surat_tugas) }}"
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="tanggal_st" value="{{ old('tanggal_st', $spp->tanggal_st ? $spp->tanggal_st->format('Y-m-d') : '') }}"
                ...
                <div class="input-group">
                    ...
                    <input type="text" name="nomor_undangan" value="{{ old('nomor_undangan', $spp->nomor_undangan) }}"
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="tanggal_mulai" value="{{ old('tanggal_mulai', $spp->tanggal_mulai ? $spp->tanggal_mulai->format('Y-m-d') : '') }}"
                ...
                <div class="input-group">
                    ...
                    <input type="date" name="tanggal_selesai" value="{{ old('tanggal_selesai', $spp->tanggal_selesai ? $spp->tanggal_selesai->format('Y-m-d') : '') }}"
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="input-group">
                    ...
                    <input type="number" name="bruto" id="bruto" value="{{ old('bruto', $spp->bruto) }}"
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="ppn" id="ppn" value="{{ old('ppn', $spp->ppn) }}"
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="pph" id="pph" value="{{ old('pph', $spp->pph) }}"
                ...
                <div class="input-group">
                    ...
                    <input type="number" name="netto" id="netto" value="{{ old('netto', $spp->netto) }}"
        ...
        <div class="card">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="input-group" id="sp2d_fields" style="display: {{ old('status', $spp->status) == 'Tagihan Telah SP2D' ? 'block' : 'none' }};">
                ...
                <div class="input-group" id="tgl_sp2d_fields" style="display: {{ old('status', $spp->status) == 'Tagihan Telah SP2D' ? 'block' : 'none' }};">
                    <label class="input-label">Tanggal SP2D</label>
                    <input type="date" name="tgl_sp2d" value="{{ old('tgl_sp2d', $spp->tgl_sp2d ? $spp->tgl_sp2d->format('Y-m-d') : '') }}"
                ...
                <div class="input-group" id="tgl_selesai_fields" style="display: {{ old('status', $spp->status) == 'Tagihan Telah SP2D' ? 'block' : 'none' }};">
                    <label class="input-label">Tanggal Selesai SP2D</label>
                    <input type="date" name="tgl_selesai_sp2d" value="{{ old('tgl_selesai_sp2d', $spp->tgl_selesai_sp2d ? $spp->tgl_selesai_sp2d->format('Y-m-d') : '') }}"
        ...
        <div class="card">
            <div class="flex justify-end gap-3">
                <a href="{{ route('anggaran.spp.show', $spp) }}" class="btn btn-outline">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    roSelect.addEventListener('change', function() {
        const ro = this.value;
        const currentSubkomp = '{{ old('sub_komponen', $spp->sub_komponen) }}';
        ...
        if (ro) {
            fetch(`{{ route('anggaran.spp.get-subkomponen') }}?ro=${ro}`)
                ...
                .then(data => {
                    ...
                    // Trigger change to load MAK if subkomponen is selected
                    if (currentSubkomp) {
                        subKomponenSelect.dispatchEvent(new Event('change'));
                    }
                });
        }
    });
    ...
    subKomponenSelect.addEventListener('change', function() {
        ...
        const currentMak = '{{ old('mak', $spp->mak) }}';
