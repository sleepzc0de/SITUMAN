        ...
        <form action="{{ route('anggaran.spp.update', $spp) }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="tgl_spp"
                            value="{{ old('tgl_spp', $spp->tgl_spp ? $spp->tgl_spp->format('Y-m-d') : '') }}"
                    ...
                    <div class="input-group">
                        ...
                        <select name="bulan" class="input-field @error('bulan') border-red-500 @enderror" required>
                            ...
                            @foreach ($bulanList as $bulan)
                                <option value="{{ $bulan }}"
                                    {{ old('bulan', $spp->bulan) == $bulan ? 'selected' : '' }}>
                                    {{ ucfirst($bulan) }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="jenis_kegiatan"
                            value="{{ old('jenis_kegiatan', $spp->jenis_kegiatan) }}"
                    ...
                    <div class="input-group">
                        ...
                        <select name="jenis_belanja" class="input-field @error('jenis_belanja') border-red-500 @enderror"
                            ...
                            @foreach ($jenisBelanja as $jenis)
                                <option value="{{ $jenis }}"
                                    {{ old('jenis_belanja', $spp->jenis_belanja) == $jenis ? 'selected' : '' }}>
                                    {{ $jenis }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-group md:col-span-2">
                        ...
                        <select name="mak" id="mak" class="input-field @error('mak') border-red-500 @enderror"
                            ...
                            @foreach ($akunList as $akun)
                                <option value="{{ $akun->kode_akun }}" data-kegiatan="{{ $akun->kode_kegiatan }}"
                                    data-kro="{{ $akun->kro }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="tanggal_st"
                            value="{{ old('tanggal_st', $spp->tanggal_st ? $spp->tanggal_st->format('Y-m-d') : '') }}"
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="tanggal_mulai"
                            value="{{ old('tanggal_mulai', $spp->tanggal_mulai ? $spp->tanggal_mulai->format('Y-m-d') : '') }}"
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="tanggal_selesai"
                            value="{{ old('tanggal_selesai', $spp->tanggal_selesai ? $spp->tanggal_selesai->format('Y-m-d') : '') }}"
            ...
            <div class="card">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="input-group">
                        ...
                        <select name="ls_bendahara" class="input-field @error('ls_bendahara') border-red-500 @enderror"
                            ...
                            @foreach ($lsBendahara as $ls)
                                <option value="{{ $ls }}"
                                    {{ old('ls_bendahara', $spp->ls_bendahara) == $ls ? 'selected' : '' }}>
                                    {{ $ls }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="input-group">
                        ...
                        <select name="status" id="status"
                            ...
                            <option value="Tagihan Belum SP2D"
                                {{ old('status', $spp->status) == 'Tagihan Belum SP2D' ? 'selected' : '' }}>
                                Tagihan Belum SP2D
                            </option>
                            <option value="Tagihan Telah SP2D"
                                {{ old('status', $spp->status) == 'Tagihan Telah SP2D' ? 'selected' : '' }}>
                                Tagihan Telah SP2D
                            </option>
                        </select>
                        @error('status')
                    ...
                    <div class="input-group" id="sp2d_fields"
                        style="display: {{ old('status', $spp->status) == 'Tagihan Telah SP2D' ? 'block' : 'none' }};">
                    ...
                    <div class="input-group" id="tgl_sp2d_fields"
                        style="display: {{ old('status', $spp->status) == 'Tagihan Telah SP2D' ? 'block' : 'none' }};">
                        <label class="input-label">Tanggal SP2D</label>
                        <input type="date" name="tgl_sp2d"
                            value="{{ old('tgl_sp2d', $spp->tgl_sp2d ? $spp->tgl_sp2d->format('Y-m-d') : '') }}"
                    ...
                    <div class="input-group" id="tgl_selesai_fields"
                        style="display: {{ old('status', $spp->status) == 'Tagihan Telah SP2D' ? 'block' : 'none' }};">
                        <label class="input-label">Tanggal Selesai SP2D</label>
                        <input type="date" name="tgl_selesai_sp2d"
                            value="{{ old('tgl_selesai_sp2d', $spp->tgl_selesai_sp2d ? $spp->tgl_selesai_sp2d->format('Y-m-d') : '') }}"
