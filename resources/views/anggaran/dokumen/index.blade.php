            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50 dark:bg-navy-800">
                    <tr>
                        ...
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Upload Oleh</th>
                        <th class="px-4 py-3 text-left text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wider">Tanggal Upload</th>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-navy-800 transition-colors">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center gap-2">
                                    <svg class="w-5 h-5 {{ file_icon_class($dokumen->file_path) }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"></path>
                                    </svg>
                                    <span class="font-medium text-gray-900 dark:text-white">{{ $dokumen->nama_dokumen }}</span>
                                </div>
                            </td>
                            <td class="px-4 py-3">
                            ...
                            <td class="px-4 py-3">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <form action="{{ route('anggaran.dokumen.destroy', $dokumen) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
