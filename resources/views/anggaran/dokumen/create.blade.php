    ...
    <form action="{{ route('anggaran.dokumen.store') }}" method="POST" enctype="multipart/form-data"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="card">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="input-group">
                            ...
                            <select name="ro" id="ro" class="input-field @error('ro') input-error @enderror"
                                x-model="selectedRO" @change="onRoChange()" required>
                        ...
                        <div class="input-group">
                            ...
                            <div class="relative">
                                <select name="sub_komponen" id="sub_komponen"
                                    ...
                                    x-model="selectedSubkomp" @change="onSubkompChange()"
                                    :disabled="!selectedRO || loadingSubkomp" required>
                                    <option value="">
                                        <span
                                            x-text="!selectedRO ? '— Pilih RO terlebih dahulu —'
                        ...
                        <div class="input-group">
                            ...
                            <select name="bulan" id="bulan" class="input-field @error('bulan') input-error @enderror"
                                required>
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nama_dokumen" id="nama_dokumen" value="{{ old('nama_dokumen') }}"
                                ...
                                placeholder="Contoh: Laporan Capaian Output Maret 2026" maxlength="255" required>
                            @error('nama_dokumen')
                                <p class="input-hint-error">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="input-group sm:col-span-2">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="3" maxlength="1000"
                                ...
                                placeholder="Keterangan tambahan (opsional, maks. 1000 karakter)">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <p class="input-hint-error">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="card">
                    ...
                    <label for="file-input"
                        ...
                        <input type="file" id="file-input" name="files[]" class="hidden"
                            accept=".pdf,.doc,.docx,.xls,.xlsx,.jpg,.jpeg,.png" multiple required
                    ...
                    <div x-show="pickedFiles.length > 0" x-transition class="mt-3 space-y-2">
                        ...
                        <template x-for="(f, i) in pickedFiles" :key="i">
                            <div
                                ...
                                <svg class="w-4 h-4 text-navy-500 flex-shrink-0" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
            ...
            <div class="space-y-5">
                ...
                <div x-show="anggaranInfo" x-transition class="card border-l-4 border-l-navy-500">
                ...
                <div class="card bg-navy-50 dark:bg-navy-900/50 !border-navy-200 dark:!border-navy-700">
                    ...
                    <ul class="text-xs text-navy-700 dark:text-navy-400 space-y-1.5">
                        <li class="flex gap-2"><span class="text-navy-400 flex-shrink-0">1.</span>Pilih RO terlebih dahulu
                        </li>
                        <li class="flex gap-2"><span class="text-navy-400 flex-shrink-0">2.</span>Pilih sub komponen yang
                            sesuai</li>
                        <li class="flex gap-2"><span class="text-navy-400 flex-shrink-0">3.</span>Pilih bulan periode
                            capaian</li>
                        <li class="flex gap-2"><span class="text-navy-400 flex-shrink-0">4.</span>Isi nama dokumen dengan
                            jelas</li>
                        <li class="flex gap-2"><span class="text-navy-400 flex-shrink-0">5.</span>Upload satu atau
                            beberapa file</li>
                    </ul>
                </div>
