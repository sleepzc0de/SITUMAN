...
<div class="space-y-6">
    ...
    <div class="card">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            ...
            <div class="flex gap-2">
                <a href="{{ route('anggaran.dokumen.download', ['dokumen' => $dokumen->id]) }}" class="btn btn-primary">
    ...
    <div class="card">
        ...
        <div class="space-y-3">
            ...
            <div class="flex justify-between py-2">
                ...
                <span class="font-semibold text-gray-900 dark:text-white">{{ $dokumen->ro }} - {{ get_ro_name($dokumen->ro) }}</span>
            </div>
            <div class="flex justify-between py-2">
            ...
            <div class="flex justify-between py-2">
                ...
                <span class="font-semibold text-gray-900 dark:text-white">{{ formatTanggalIndo($dokumen->created_at) }}</span>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="bg-gray-50 dark:bg-navy-800 rounded-xl p-8 text-center">
            <svg class="w-20 h-20 mx-auto {{ file_icon_class($dokumen->file_path) }} mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">{{ strtoupper(pathinfo($dokumen->file_path, PATHINFO_EXTENSION)) }}</p>
            <a href="{{ route('anggaran.dokumen.download', ['dokumen' => $dokumen->id]) }}" class="btn btn-primary inline-flex">
                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                </svg>
                Download File
