...
@section('content')
    <div x-data="revisiForm()" class="space-y-6">
        ...
        <div class="alert alert-info">
            ...
            <p>Revisi anggaran <strong>tidak dapat diedit</strong> setelah disimpan untuk menjaga integritas audit trail.
                Pastikan semua data sudah benar sebelum menyimpan.</p>
        </div>
                            ...
                            <div class="grid grid-cols-3 gap-3 text-sm">
                                ...
                                <div>
                                    ...
                                    <p class="font-semibold text-gray-900 dark:text-white"
                                        x-text="selectedAnggaran.subkomp"></p>
                                </div>
                                <div>
                                    <p class="text-gray-500 dark:text-gray-400 text-xs mb-0.5">Kode Akun</p>
                                    <p class="font-semibold text-gray-900 dark:text-white" x-text="selectedAnggaran.akun">
                                    </p>
                                </div>
                            </div>
                            <div class="mt-3">
                                ...
                                <p class="text-sm text-gray-700 dark:text-gray-300 leading-relaxed"
                                    x-text="selectedAnggaran.uraian"></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div class="input-group">
                                ...
                                <input type="text" x-model="paguSebelumFormatted" class="input-field-readonly" readonly
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="pagu_sesudah_display" x-on:input="onPaguSesudahInput($event)"
                                    class="input-field @error('pagu_sesudah') input-error @enderror"
                                    placeholder="Masukkan pagu baru" autocomplete="off" required>
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        <p class="text-xs font-semibold uppercase tracking-wide"
                                            :class="selisih > 0 ? 'text-emerald-600 dark:text-emerald-400' : selisih < 0 ?
                                                'text-red-600 dark:text-red-400' : 'text-gray-500'">
                                            Selisih Perubahan
                                        </p>
                                        <p class="text-xl font-bold mt-1"
                                            :class="selisih > 0 ? 'text-emerald-700 dark:text-emerald-300' : selisih < 0 ?
                                                'text-red-700 dark:text-red-300' : 'text-gray-600'">
                                            <span x-text="selisih > 0 ? '+' : ''"></span><span
                                    ...
                                    <div class="text-right">
                                        <span class="badge text-sm"
                                            ...
                                            <span
                                                x-text="selisih > 0 ? '↑ Naik' : selisih < 0 ? '↓ Turun' : '= Tetap'"></span>
                                        </span>
                                        <p class="text-xs mt-1"
                                            :class="selisih > 0 ? 'text-emerald-600 dark:text-emerald-400' :
                    ...
                    <div class="card">
                        ...
                        <div class="space-y-4">
                            <div class="input-group">
                                ...
                                <textarea name="alasan_revisi" rows="4" maxlength="1000"
                                    class="input-field @error('alasan_revisi') input-error @enderror"
                                    placeholder="Jelaskan latar belakang dan alasan dilakukan revisi anggaran ini... (maks. 1000 karakter)" required>{{ old('alasan_revisi') }}</textarea>
                                @error('alasan_revisi')
                                    <p class="input-hint-error">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div class="input-group">
                                ...
                                <div x-data="fileDropzone()"
                                    ...
                                    :class="dragging ? 'border-navy-400 bg-navy-50 dark:bg-navy-800/50' :
                                        'border-gray-200 dark:border-navy-600 hover:border-navy-300 dark:hover:border-navy-500'"
                                    @dragover.prevent="dragging=true" @dragleave.prevent="dragging=false"
                                    @drop.prevent="handleDrop($event)" @click="$refs.fileInput.click()">
                                    <svg class="w-10 h-10 mx-auto mb-3 text-gray-400 dark:text-gray-500" fill="none"
                                    ...
                                    <input type="file" name="dokumen_pendukung" accept=".pdf" x-ref="fileInput"
                        ...
                        <div class="space-y-4">
                            <div class="input-group">
                                ...
                                <select name="jenis_revisi"
                                    class="input-field @error('jenis_revisi') input-error @enderror" required>
                                    <option value="">Pilih jenis</option>
                                    @foreach ($jenisRevisi as $jenis)
                                        <option value="{{ $jenis }}"
                                            {{ old('jenis_revisi') == $jenis ? 'selected' : '' }}>
                                            {{ $jenis }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" name="tanggal_revisi"
                                    ...
                                    class="input-field @error('tanggal_revisi') input-error @enderror" required>
                        ...
                        <div class="space-y-3 text-sm">
                            <div class="flex justify-between">
                                ...
                                <span class="font-semibold text-gray-900 dark:text-white"
                                    x-text="paguSebelumFormatted || '-'"></span>
                            </div>
                            <div class="flex justify-between">
