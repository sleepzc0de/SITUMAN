    ...
    <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
        <div>
            <nav class="breadcrumb mb-2" aria-label="Breadcrumb">
                ...
                <svg class="w-3.5 h-3.5 mx-1 text-gray-300 dark:text-gray-600" fill="none" stroke="currentColor"
                    viewBox="0 0 24 24">
...
@section('content')
    ...
    <div class="space-y-6 animate-fade-in" x-data="gradingIndex()">
        ...
        <div class="flex flex-wrap items-center justify-end gap-2">
            ...
            {{-- Filter Bagian --}}
            <div class="relative">
                <select x-model="filters.bagian" @change="fetchData()"
            ...
            {{-- Export --}}
            <a :href="`{{ route('kepegawaian.grading') }}?tahun=${encodeURIComponent(filters.tahun)}&bagian=${encodeURIComponent(filters.bagian)}&export=1`"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div class="card flex items-start gap-4 !p-5">
                <div
                    class="w-12 h-12 rounded-xl bg-emerald-100 dark:bg-emerald-900/30
            ...
            <div class="card flex items-start gap-4 !p-5">
                <div
                    class="w-12 h-12 rounded-xl bg-navy-100 dark:bg-navy-700
                        flex items-center justify-center flex-shrink-0">
            ...
            <div class="card flex items-start gap-4 !p-5">
                <div
                    class="w-12 h-12 rounded-xl bg-gold-100 dark:bg-gold-900/20
                        flex items-center justify-center flex-shrink-0">
            ...
            <div class="card flex items-start gap-4 !p-5">
                <div
                    class="w-12 h-12 rounded-xl bg-purple-100 dark:bg-purple-900/20
                        flex items-center justify-center flex-shrink-0">
                    ...
                    <template x-for="item in perBagian" :key="item.bagian">
                        <div>
                            ...
                            <div class="progress-bar-wrap !h-1.5">
                                <div class="progress-bar-navy transition-all duration-500" :style="`width: ${item.pct}%`">
                                </div>
                            </div>
                        </div>
                    </template>
        ...
        <div class="card !p-0 overflow-hidden">
            <div
                class="px-5 py-4 border-b border-gray-100 dark:border-navy-700
                ...
                <div class="relative">
                    ...
                    <input type="text" x-model="filters.search" @input.debounce.300ms="fetchData()"
                        placeholder="Cari nama / NIP..." class="input-field !pl-9 !py-2 !text-xs w-52">
                </div>
            </div>
            ...
            <div x-show="loading" x-transition:enter="transition-opacity duration-150"
                ...
                x-transition:leave-end="opacity-0" class="flex items-center justify-center py-20 gap-3"
                style="display:none;">
                        ...
                        <tbody>
                            ...
                            <template x-for="(row, index) in rows" :key="row.id">
                                <tr class="hover:bg-navy-50/30 dark:hover:bg-navy-700/30 transition-colors">
                                    ...
                                    <td class="text-gray-400 dark:text-gray-500 text-center text-sm" x-text="index + 1">
                                    </td>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-3">
                                            <div
                                                class="w-9 h-9 bg-gradient-to-br from-navy-500 to-navy-700
                                    ...
                                    <td>
                                        ...
                                        <p class="text-xs text-gray-400 dark:text-gray-500 mt-0.5" x-show="row.bagian"
                                            x-text="row.bagian"></p>
                                    </td>

                                    {{-- Level --}}
                                    <td class="text-center">
                                        <span class="badge badge-info text-xs" x-text="row.level_jabatan"></span>
                                    </td>
                    ...
                    @php
                        $referensi = [
                            ...
                            [
                                'label' => 'Eselon III',
                                'max' => 18,
                                'color' => 'bg-navy-100 dark:bg-navy-700 text-navy-700 dark:text-navy-200',
                            ],
                            [
                                'label' => 'Eselon IV',
                                'max' => 16,
                            ...
                            [
                                'label' => 'Pelaksana',
                                'max' => 12,
                                'color' => 'bg-gold-100 dark:bg-gold-900/20 text-gold-700 dark:text-gold-300',
                            ],
                        ];
                    @endphp
