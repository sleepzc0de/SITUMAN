                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div class="md:col-span-2">
                        ...
                        <input type="text" name="nama" value="{{ old('nama') }}"
                            class="input-field @error('nama') border-red-400 focus:border-red-400 focus:ring-red-100 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" name="nama_gelar" value="{{ old('nama_gelar') }}"
                            class="input-field" placeholder="Cth: Dr. Budi Santoso, S.E., M.M.">
                    </div>
                    <div>
                        <label class="input-label">NIP <span class="text-red-500">*</span></label>
                        <input type="text" name="nip" value="{{ old('nip') }}"
                            class="input-field font-mono @error('nip') border-red-400 @enderror"
                    ...
                    <div>
                        ...
                        <input type="number" name="usia" value="{{ old('usia') }}" class="input-field" min="17" max="70" placeholder="Otomatis dari tgl lahir">
                    </div>
                    <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    <div>
                        ...
                        <input type="text" name="jabatan" value="{{ old('jabatan') }}"
                            class="input-field" placeholder="Cth: Analis Kepegawaian">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" name="bagian" value="{{ old('bagian') }}"
                            class="input-field" placeholder="Nama bagian" list="bagian-list">
                    ...
                    <div>
                        ...
                        <input type="text" name="subbagian" value="{{ old('subbagian') }}"
                            class="input-field" placeholder="Nama subbagian" list="subbagian-list">
                    ...
                    <div>
                        ...
                        <input type="text" name="lokasi" value="{{ old('lokasi') }}"
                            class="input-field" placeholder="Cth: Kantor Pusat Jakarta">
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            <input type="number" name="grading" value="{{ old('grading') }}"
                                class="input-field pr-16" min="1" max="16" placeholder="0">
                    ...
                    <div>
                        ...
                        <input type="text" name="pangkat" value="{{ old('pangkat') }}"
                            class="input-field" placeholder="Cth: III/c">
                    </div>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'kepegawaian'" class="p-6" style="display:none">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div class="grid grid-cols-2 gap-2">
                            <div class="relative">
                                <input type="number" name="masa_kerja_tahun" value="{{ old('masa_kerja_tahun') }}"
                                    class="input-field pr-12" min="0" placeholder="0">
                            ...
                            <div class="relative">
                                <input type="number" name="masa_kerja_bulan" value="{{ old('masa_kerja_bulan') }}"
                                    class="input-field pr-12" min="0" max="11" placeholder="0">
                    ...
                    <div>
                        ...
                        <input type="number" name="tahun_pensiun" value="{{ old('tahun_pensiun') }}"
                            class="input-field" min="{{ date('Y') }}" max="{{ date('Y') + 40 }}" placeholder="{{ date('Y') + 10 }}">
                    </div>
                    <div>
                        <label class="input-label">Proyeksi KP 1</label>
                        <input type="text" name="proyeksi_kp_1" value="{{ old('proyeksi_kp_1') }}"
                            class="input-field" placeholder="Cth: 1 April 2025">
                    </div>
                    <div>
                        <label class="input-label">Proyeksi KP 2</label>
                        <input type="text" name="proyeksi_kp_2" value="{{ old('proyeksi_kp_2') }}"
                            class="input-field" placeholder="Cth: 1 Oktober 2027">
                    </div>
                    <div class="md:col-span-2">
                        <label class="input-label">Keterangan KP</label>
                        <textarea name="keterangan_kp" rows="3"
                            class="input-field resize-none"
                            placeholder="Catatan atau keterangan terkait kenaikan pangkat...">{{ old('keterangan_kp') }}</textarea>
                    </div>
                </div>
            </div>
            ...
            <div x-show="activeTab === 'pendidikan'" class="p-6" style="display:none">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        ...
                        <input type="text" name="jurusan_s1" value="{{ old('jurusan_s1') }}"
                            class="input-field" placeholder="Cth: Akuntansi">
                    </div>
                    <div>
                        <label class="input-label">Jurusan / Prodi S2</label>
                        <input type="text" name="jurusan_s2" value="{{ old('jurusan_s2') }}"
                            class="input-field" placeholder="Cth: Manajemen Keuangan">
                    </div>
                    <div>
                        <label class="input-label">Jurusan / Prodi S3</label>
                        <input type="text" name="jurusan_s3" value="{{ old('jurusan_s3') }}"
                            class="input-field" placeholder="Cth: Ilmu Administrasi">
                    </div>
                </div>
            </div>
        </div>
