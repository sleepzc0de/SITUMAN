                        ...
                        <div>
                            ...
                            <select name="jenis_jabatan" class="input-field">
                                ...
                                @foreach (['Struktural', 'Fungsional', 'Pelaksana'] as $jj)
                                    <option value="{{ $jj }}"
                                        {{ old('jenis_jabatan') == $jj ? 'selected' : '' }}>{{ $jj }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="md:col-span-2">
                        ...
                        <div>
                            ...
                            <select name="eselon" class="input-field">
                                ...
                                @foreach (['Eselon I', 'Eselon II', 'Eselon III', 'Eselon IV', 'Non Eselon'] as $e)
                                    <option value="{{ $e }}" {{ old('eselon') == $e ? 'selected' : '' }}>
                                        {{ $e }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <select name="jenis_pegawai" class="input-field">
                                ...
                                @foreach (['PNS', 'PPPK', 'Honorer'] as $jp)
                                    <option value="{{ $jp }}"
                                        {{ old('jenis_pegawai') == $jp ? 'selected' : '' }}>{{ $jp }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="status" class="input-field">
                                ...
                                @foreach (['AKTIF', 'CLTN', 'PENSIUN', 'NON AKTIF'] as $s)
                                    <option value="{{ $s }}"
                                        {{ old('status', 'AKTIF') == $s ? 'selected' : '' }}>{{ $s }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            ...
                            <div class="relative">
                                <input type="number" name="grading" value="{{ old('grading') }}"
                                    class="input-field pr-12" min="1" max="16" placeholder="—">
                                <span
                ...
                <div x-show="activeTab === 'kepegawaian'" class="p-6" style="display:none">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                <div class="relative">
                                    <input type="number" name="masa_kerja_tahun" value="{{ old('masa_kerja_tahun') }}"
                                        class="input-field pr-14" min="0" placeholder="0">
                                    <span
                                ...
                                <div class="relative">
                                    <input type="number" name="masa_kerja_bulan" value="{{ old('masa_kerja_bulan') }}"
                                        class="input-field pr-14" min="0" max="11" placeholder="0">
                                    <span
                        ...
                        <div>
                            ...
                            <input type="date" name="tanggal_pensiun" value="{{ old('tanggal_pensiun') }}"
                                class="input-field">
                        </div>
                        <div>
                            <label class="input-label">Tahun Pensiun</label>
                            <input type="number" name="tahun_pensiun" value="{{ old('tahun_pensiun') }}"
                                class="input-field" min="{{ date('Y') }}" max="{{ date('Y') + 40 }}"
