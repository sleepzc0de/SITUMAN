...
Route::middleware(['auth', 'has.role'])->group(function () {
    ...
    Route::prefix('anggaran')->name('anggaran.')->group(function () {
        ...
        Route::get('monitoring/data',
            [MonitoringAnggaranController::class, 'data'])->name('monitoring.data');
        Route::get('monitoring/export',
            [MonitoringAnggaranController::class, 'export'])->name('monitoring.export');
        ...
        Route::get('dokumen/{id}/download/{file}',
